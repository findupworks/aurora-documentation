...
<Steps>
  <Step title="Acessar o Builder de Flows">
  ...
  <Step title="Configurar Cada Passo">
...
<Card title="Documentação Flow" icon="chart-diagram" href="/flow/index">
Acesse a documentação geral do módulo de Flow, para aprender mais.
</Card>
