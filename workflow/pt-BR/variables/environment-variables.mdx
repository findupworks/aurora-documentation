...
Las variables de entorno en Aurora Workflow.funcionan en dos niveles:
...
<Callout type="info">
  Las variables de entorno del espacio de trabajo tienen prioridad sobre las
  personales cuando hay un conflicto de nombres.
</Callout>
...
<Callout type="warning">
  Elige los nombres de las variables cuidadosamente para evitar sobrescrituras
  no deseadas. Considera usar prefijos con tus iniciales para variables
  personales o con el nombre del proyecto para variables del espacio de trabajo.
</Callout>
