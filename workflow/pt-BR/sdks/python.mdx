...
El SDK oficial de Python para Aurora Workflow.te permite ejecutar flujos de trabajo programáticamente desde tus aplicaciones Python utilizando el SDK oficial de Python.
...
client = SimStudioClient(
    ...
    base_url="https://Aurora Workflow.ai"  # optional, defaults to https://Aurora Workflow.ai
)
...
```python
SimStudioClient(api_key: str, base_url: str = "https://Aurora Workflow.ai")
```
...
<Tabs items={['Development', 'Production']}>
  <Tab value="Development">
    ...
    client = SimStudioClient(
        ...
        base_url=os.getenv("SIM_BASE_URL", "https://Aurora Workflow.ai")
    )
    ```
