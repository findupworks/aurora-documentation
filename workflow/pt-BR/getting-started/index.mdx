...
![Exemplo de primeiros passos](/images/base-blocks.png)
...
<Cards>
  ...
  <Card
    title="Adicionar lógica personalizada"
    href="/workflow/pt-BR/blocks/function"
  >
    Use blocos de Função para processamento personalizado de dados
  </Card>
  <Card
    title="Implementar seu fluxo de trabalho"
    href="/workflow/pt-BR/execution"
  >
