...
Simplemente carga tus documentos para comenzar. Aurora Workflow.los procesa automáticamente en segundo plano, extrayendo texto, creando incrustaciones y dividiéndolos en fragmentos buscables.
...
<Image
  src="/static/knowledgebase/knowledgebase.png"
  alt="Vista de fragmentos de documentos mostrando contenido procesado"
  width={800}
  height={500}
/>
...
Para documentos PDF, Aurora Workflow.ofrece capacidades de procesamiento mejoradas:
...
<Image
  src="/static/knowledgebase/knowledgebase-2.png"
  alt="Uso del bloque de conocimiento en flujos de trabajo"
  width={800}
  height={500}
/>
...
Aurora Workflow.utiliza búsqueda vectorial impulsada por [pgvector](https://github.com/pgvector/pgvector) para entender el significado y contexto de tu contenido:
