...
O motor de execução do Sim dá vida aos seus fluxos de trabalho processando blocos na ordem correta, gerenciando o fluxo de dados e lidando com erros elegantemente, para que você possa entender exatamente como os fluxos de trabalho são executados no Sim.
...
<Cards>
  <Card title="Fundamentos de execução" href="/execution/basics">
  ...
  <Card title="Cálculo de custos" href="/execution/costs">
...
- Cria um ponto de conexão HTTP único: `https://sim.ai/api/workflows/{workflowId}/execute`
...
- Hospedado em um subdomínio personalizado: `https://your-name.sim.ai`
...
Comece com [Fundamentos de execução](/execution/basics) para entender como os fluxos de trabalho funcionam, depois explore [Registro](/execution/logging) para monitorar suas execuções e [Cálculo de custos](/execution/costs) para otimizar seus gastos.
