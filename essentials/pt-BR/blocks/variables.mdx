...
<Steps>
  <Step>
    <strong>Atualizar variáveis do fluxo de trabalho</strong>: Alterar valores de variáveis durante a execução
  </Step>
  <Step>
    <strong>Armazenar dados dinâmicos</strong>: Capturar saídas de blocos em variáveis
  </Step>
  <Step>
    <strong>Manter o estado</strong>: Acompanhar contadores, indicadores e resultados intermediários
  </Step>
</Steps>
